...
import {
  FlightCard,
  FlightCardLoading,
} from "@/components/generative-ui/flight-card";

export const searchFlightsUI = tool({
  description:
  ...
  async *generate({ from, to, date }) {
    // Show loading state
    yield <FlightCardLoading />;
    ...
    // Return the final UI component with data
    return <FlightCard data={flightData} />;
  },
});
